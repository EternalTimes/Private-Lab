<!-- theme purenice designed & coded by wendale & edited by EternalTimes-->
<!DOCTYPE html>
...
<head>
    ...
    <link rel="icon" href="https://raw.githubusercontent.com/EternalTimes/Private-Lab/master/OneDrive.ico" type="image/x-icon" />
    <link rel="shortcut icon" href="https://raw.githubusercontent.com/EternalTimes/Private-Lab/master/OneDrive.ico" type="image/x-icon" />

    <style type="text/css">
        body{margin:0;padding:0;font-family:'Google Sans','Microsoft yahei',sans-serif;font-size:14px;line-height:1em;color:#000;background:url(https://uploadbeta.com/api/pictures/random/?key=BingEverydayWallpaperPicture);background-attachment:fixed;background-repeat: no-repeat;background-position:50% 50%}
        ...
        .changelanguage{cursor:pointer;color:#ffffff;height:30px;background:#FF7D00;padding:0 20px;border-width:0;border-radius:6px;box-shadow: 0px 4px 12px rgba(255, 125, 0, 0.5);float:right;margin-right:10%;margin-top:5px;}
        .title{text-align:center;background:#ffffffcc;border-radius: 6px;float:middle;margin-left:100px;margin-right:100px;}
        .title a{color:#171D33;line-height:42px;font-size:32px;text-decoration:none}
        .list-wrapper{width:95%;margin:0 auto;position:center;}
        .list-container{position:center;}
        ...
        .list-header-container a.back-link ion-icon{font-size:14px;}
        .list-header-container a.back-link:hover{color:white}
        .list-container,.list-header-container,.list-wrapper,a.back-link:hover,body{color:#24292e}
        .table-header{display:block;float:left;margin:10px 0 0 30px;height:40px;line-height:40px;text-align:left;font-weight:400;color:#A0A4B0;word-break: break-all;word-wrap: break-word;}
        .fix{height:60px;}
        .list-body-container{position:center;overflow-x:hidden;overflow-y:hidden;box-sizing:border-box;}
        ...
        .list-table tr{display:block;margin:10px 20px;width:96%;float:left;background:#ffffffcc;box-shadow: 0px 4px 26px rgba(0, 0, 0, 0.06);border-radius: 6px;}
        .list-table tr[data-to]:hover{background:#10C971;color:white;}
        .list-table tr[data-to]:hover a{color:white}
        .list-table td,.list-table th{display:block;float:left;line-height:30px;text-align:left;}
        .list-table td button,.list-table th button{cursor:pointer;color:#ffffff;height:25px;margin-top:5px;background:#FF7D00;padding:0 20px;border-width:0;border-radius:6px;box-shadow: 0px 4px 12px rgba(255, 125, 0, 0.5);}
        .list-table td.file,.list-table th.file{width:60%;color:#171D33;padding-left:20px;}
        .list-table td.file ion-icon{float:left;margin-top:6px;margin-right:5px;}
        ...
        .list-table td.updated_at,.list-table th.updated_at{width:20%;}
...
<?php if ($_SERVER['admin']) { ?>
        ...
        .operate ul{position:absolute;display:none;background:#ffffffbb;border:0;border-radius:5px;margin:0;padding:0.7px;color:#205D67;z-index:1;box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.2);}
...
<?php } ?>
        ...
        @media only screen and (max-width:480px){
            ...
            .list-wrapper{width:75%; margin-bottom:24px;}
        ...
        .upload_style{height:30px;width:96%;margin:20px;background:#ffffffcc;box-shadow: 0px 4px 26px rgba(0, 0, 0, 0.06);border-radius: 6px;}
        .upload_style input[type="file"]{display:block;color:#fff;background:#613EEACC;border-radius:6px;float:left;height:25px;margin:2px 20px 20px 2px;outline:none;font-size:14px;text-align:center;width:200px}
        .upload_style input[type="button"]{display:block;color:#fff;float:right;height:25px;margin-top:2px;margin-bottom:2px;margin-right:2px;width:160px;outline:none;font-size:16px;background:#613EEA;border-radius:6px;border:0;}
...
<?php           } elseif (isset($files['folder'])) {
                ...
                <table class="list-table" id="list-table">
                    <tr id="tr0">
                        ...
                        <th class="updated_at" width="12%"><a onclick="sortby('time');"><?php echo getconstStr('EditTime'); ?></a></th>
                        <th class="size" width="12%"><a onclick="sortby('size');"><?php echo getconstStr('Size'); ?></a></th>
                    </tr>
                    <!-- Dirs -->
